class StoredProcedure():
    def __init__(self):
        ...
        self.addReferenceBook = 'EXEC addReferenceBook ?,?,?,?,?'
        self.removeReferenceBook = 'EXEC removeReferenceBook ?,?,?,?,?'
        ...
        self.referenceBookOfMainResponsibleSubject = 'EXEC referenceBookOfMainResponsibleSubject ?'
